-- =====================================================================
-- org-chart · 009 · RPC get_users_companies (bypass RLS company_members)
--
...
-- mọi authenticated. Acceptable — info này cross-ws sharing đã hiển thị
-- công khai. Job_title cũng expose qua đây.
-- =====================================================================

create or replace function app_org_chart.get_users_companies(p_user_ids uuid[])
returns table (
  user_id      uuid,
  company_id   uuid,
  company_name text,
...
$$;
grant execute on function app_org_chart.get_users_companies(uuid[]) to authenticated;
